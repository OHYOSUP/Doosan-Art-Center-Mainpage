...
if(matchMedia("screen and (min-width: 1024px) and (max-width: 1746px").matches){
...
if(matchMedia("screen and (min-width: 453px) and (max-width: 1023px").matches){
...
if(matchMedia("screen and (max-width: 452px)").matches){
